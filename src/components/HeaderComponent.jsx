            ...
            <div xui-aos="fade-left" xui-aos-duration=".8" className='xui-lg-col-6 xui-col-12'>
                ...
                {isDownload ? (
                    <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1 xui-mt-1-half'>
                        <Link to='/' className='xui-d-inline-block xui-text-dc-none'><img src={AppDownload} className='xui-lg-img-200 xui-img-150' alt="" /></Link>
                        <Link to='/' className='xui-d-inline-block xui-text-dc-none'><img src={PlayDownload} className='xui-lg-img-200 xui-img-150' alt="" /></Link>
                    </div>
                ) : (
                    <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1 xui-mt-1-half'>
                        <Link to='/' className='xui-text-dc-none xui-text-white xui-py-1 xui-bdr-rad-half xui-px-1-half xui-bg-black xui-lg-font-sz-100 xui-font-sz-90'>Get Started</Link>
                    </div>
                )}
            </div>
            <div xui-aos="fade-right" xui-aos-duration=".8" xui-aos-delay=".25"  className='xui-lg-col-6 xui-col-12 xui-lg-mt-none xui-mt-2'>
