export default function ThreeUsers(props){
    return(
        ...
        <g id="Iconly/Light/3-User" stroke={props.fill}  strokeWidth="1.2"  fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
            <g id="3-User" transform="translate(1.000000, 3.500000)" stroke={props.fill}  strokeWidth="1.2" >
