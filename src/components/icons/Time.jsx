export default function Time(props){
    return(
        ...
        <svg width={props.width}  height={props.height}  viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <g id="Iconly/Light/Time-Circle" stroke={props.fill}  strokeWidth="1.2"  fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
                <g id="Time-Circle" transform="translate(2.000000, 2.000000)" stroke="#000000"  strokeWidth={props.fill} >
